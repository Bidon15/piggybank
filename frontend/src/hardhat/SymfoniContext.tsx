...
import { PiggyBank__factory } from "./typechain/factories/PiggyBank__factory";
...
export const PiggyBankContext = React.createContext<SymfoniPiggyBank>(emptyContract);
...
export interface SymfoniPiggyBank {
    instance?: PiggyBank;
    factory?: PiggyBank__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [PiggyBank, setPiggyBank] = useState<SymfoniPiggyBank>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setPiggyBank(getPiggyBank(_provider, _signer))
                finish(text)
            }
    ...
    const getPiggyBank = (_provider: providers.Provider, _signer?: Signer) => {
        let instance = _signer ? PiggyBank__factory.connect(ethers.constants.AddressZero, _signer) : PiggyBank__factory.connect(ethers.constants.AddressZero, _provider)
        const contract: SymfoniPiggyBank = {
            instance: instance,
            factory: _signer ? new PiggyBank__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <PiggyBankContext.Provider value={PiggyBank}>
                            {showLoading && loading ?
